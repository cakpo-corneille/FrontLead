...
const FEATURES = [
  ...
  { icon: Check, label: 'Double Opt-In', desc: 'Vérification SMS pour des clients certifiés.' },
];
    ...
    return (
      <div className="space-y-6 max-w-4xl mx-auto">
        <div>
          ...
          <p className="text-muted-foreground">Configurez votre formulaire d'identification de vos clients.</p>
        </div>
        ...
        <CardContent className="space-y-4">
          ...
          <div className="flex items-center justify-between rounded-lg border p-4 opacity-60">
            <div className="space-y-0.5">
              ...
              <p className="text-sm text-muted-foreground">
                Fonctionnalité à venir, vérification SMS pour des clients certifiés.
              </p>
            </div>
            <Switch
              id="double-opt-in"
