...
type Tab = 'profil' | 'compte' | 'facturation';
      ...
      <form onSubmit={profileForm.handleSubmit(onProfileSubmit)}>
        ...
        <FieldRow label="Téléphone" icon={Phone}>
          <FormField control={profileForm.control} name="phone_contact" render={({ field }) => (
            <FormItem>
              <FormControl><PhoneInput defaultCountry="BJ" {...field} value={field.value || ''} disabled={!isEditing} /></FormControl>
              <FormMessage />
            </FormItem>
          )} />
        </FieldRow>
            ...
            <FormItem>
              <FormControl>
                ...
                >
                  ...
                  <option value="collect_leads">Collecter des leads</option>
