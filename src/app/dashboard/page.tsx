      ...
      {isLoading ? (
        ...
        <>
          <div className="grid gap-2 md:gap-4 md:grid-cols-2 lg:grid-cols-4">
              ...
              <Card>
                <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                    <CardTitle className="text-sm font-medium">Leads (cette semaine)</CardTitle>
              ...
              <Card>
                <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                    <CardTitle className="text-sm font-medium">Leads Vérifiés</CardTitle>
          ...
          <div className="grid grid-cols-1 gap-2 md:gap-4 lg:grid-cols-5 lg:items-start">
            <Card className="lg:col-span-3">
                <CardHeader>
                  ...
                  <CardDescription>Nombre de leads collectés heure par heure.</CardDescription>
                </CardHeader>
                <CardContent className="pl-2">
                  {formattedChartData && formattedChartData.length > 0 ? (
                    ...
                    <div className="h-[350px] w-full flex flex-col items-center justify-center text-center">
                        ...
                        <p className="mt-2 text-sm text-muted-foreground">
                            Aucun lead n'a été collecté au cours des dernières 24 heures.
                        </p>
                    </div>
                  )}
                </CardContent>
