          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-muted-foreground">
                {alert.existing_client_first_name || alert.existing_client_last_name || alert.existing_client_phone || alert.existing_client_email || `#${alert.existing_client}`} · {formatDate(alert.created_at)}
              </p>
            </div>
          </div>
          <Badge
