...
export function Features() {
  ...
  return (
    ...
    >
      ...
      <div
        className="orb orb-1"
        style={{ width: 420, height: 420, top: "-80px", left: "-100px", background: "rgba(30,58,138,0.35)" }}
      />
      <div
        className="orb orb-2"
        style={{ width: 360, height: 360, bottom: "10%", right: "-80px", background: "rgba(52,211,153,0.18)" }}
      />
      <div
        className="orb orb-3"
        style={{ width: 280, height: 280, top: "40%", left: "45%", background: "rgba(56,189,248,0.12)" }}
      />
                ...
                <h3 className="font-headline text-2xl font-bold text-white mb-3">
                  ...
                  {feature.title.includes("ARCEP") ? (
                    <>
                      ...
                      <span style={{ color: "#34D399" }}>ARCEP</span>
                ...
                <p className="text-slate-400 leading-relaxed text-lg">
                  ...
                  {feature.description.includes("ARCEP") ? (
                    <>
                      ...
                      <span style={{ color: "#34D399", fontWeight: 600 }}>ARCEP</span>
