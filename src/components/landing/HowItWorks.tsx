...
export function HowItWorks() {
  ...
  const steps = [
    {
      number: "01",
      title: "Collez le snippet",
      description: "Ajoutez une seule ligne de script dans votre portail captif MikroTik, UniFi ou pfSense. Aucune modification de votre infrastructure réseau.",
      visual: (
    ...
    {
      number: "03",
      title: "Les leads arrivent dans votre dashboard",
      description: "Chaque contact est capturé, vérifié et stocké dans votre tableau de bord. Consultez vos statistiques, exportez vos leads, envoyez des campagnes.",
      visual: (
          ...
          <div className="p-4">
            <div className="grid grid-cols-2 gap-2 mb-3">
              {[
                ...
                { label: "Taux retour", value: "96%", color: '#34D399' },
              ].map(kpi => (
  ...
  return (
    <section id="how-it-works" ref={ref} className="py-24" style={{ background: '#1E293B' }}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        <div className={`text-center mb-16 transition-all duration-700 ${inView ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
          ...
          <h2 className="font-headline text-3xl md:text-4xl font-bold text-white mb-4">
            De zéro à 100 leads en moins de 5 minutes
          </h2>
          <p className="text-slate-400 text-lg max-w-2xl mx-auto">
            Aucun remplacement de votre système existant. Juste un overlay intelligent qui collecte des données pour vous.
          </p>
        </div>
            ...
            >
              <div className={i % 2 === 1 ? 'md:order-2' : ''}>
                <div className="flex items-center gap-3 mb-4">
                  <span
                    className="font-headline text-5xl font-bold opacity-20"
                    style={{ color: '#1E3A8A' }}
                  >
                    {step.number}
                  </span>
