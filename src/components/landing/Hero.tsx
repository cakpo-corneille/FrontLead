        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className={`transition-all duration-700 ${inView ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}>
            <div
              ...
              style={{ background: "rgba(239,68,68,0.15)", color: "#fee2e2", border: "1px solid rgba(239,68,68,0.3)" }}
            >
              <span className="w-1.5 h-1.5 rounded-full animate-pulse" style={{ background: "#f87171" }} />
              ⚠ Conforme aux exigences ARCEP 2026 ?
            </div>
            ...
            <div className="flex flex-wrap gap-4 text-sm text-blue-200">
              {["Fonctionne avec MikroTik", "Paiement Mobile Money", "Registre conforme ARCEP"].map(item => (
