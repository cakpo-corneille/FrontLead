...
const faqs = [
  ...
  {
    q: "Est-il légal de collecter ces données ?",
    a: "Oui, à condition d'informer clairement vos clients et d'obtenir leur consentement, ce que WiFiLeads fait automatiquement avec une mention légale visible dans le formulaire. Nous respectons les recommandations de la CRIET (Bénin) et de la réglementation RGPD applicable.",
  },
  {
