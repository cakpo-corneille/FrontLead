...
import type { ConnectionSession, Lead } from '@/lib/types';
          ...
          {isLoading ? (
            ...
            <>
              ...
              <div className="space-y-2">
                <h4 className="text-sm font-semibold text-foreground">Toutes les sessions</h4>
                      ...
                      <div key={s.id} className="border rounded-lg p-3 space-y-2 bg-card">
                        <div className="flex items-start justify-between gap-2">
                          ...
                          {s.is_active ? (
                            ...
                            <Badge variant="secondary" className="text-xs shrink-0">Terminée</Badge>
                          )}
                        </div>
