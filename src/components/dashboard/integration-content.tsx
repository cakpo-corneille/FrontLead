          ...
          <div className="flex items-center justify-between flex-wrap gap-3">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <CardDescription>Suivez en temps réel chaque connexion (durée, trafic, plan, revenus).</CardDescription>
              </div>
            </div>
          </div>
        </CardHeader>
        <CardContent className="p-6 space-y-6">
          <div className="grid md:grid-cols-2 gap-6">
            <div className="space-y-4">
              <label className="text-sm font-semibold text-foreground">status.html</label>
              {!formConfig?.tracking_snippet?.full ? (
                <Skeleton className="h-32 w-full rounded-xl" />
              ) : (
                <CodeBlock snippet={formConfig.tracking_snippet.full} />
              )}
              <div className="flex items-start gap-3 p-4 rounded-xl border bg-blue-50/50 border-blue-100">
                <StepBadge n={1} color="blue" />
                <div className="space-y-1">
                  <p className="font-semibold text-foreground text-sm">Synchronisation complète</p>
                  <p className="text-xs text-muted-foreground leading-relaxed">
                    Copiez ce snippet et collez-le dans <strong>status.html</strong> juste avant la balise <code>&lt;/body&gt;</code>. Cela permet d'identifier et synchroniser le client.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-4">
              <label className="text-sm font-semibold text-foreground">logout.html</label>
              {!formConfig?.tracking_snippet?.logout ? (
                <Skeleton className="h-32 w-full rounded-xl" />
              ) : (
                <CodeBlock snippet={formConfig.tracking_snippet.logout} />
              )}
              <div className="flex items-start gap-3 p-4 rounded-xl border bg-indigo-50/50 border-indigo-100">
                ...
                <div className="space-y-1">
                  ...
                  <p className="text-xs text-muted-foreground leading-relaxed">
                    Copiez ce snippet et collez-le dans <strong>logout.html</strong> juste avant la balise <code>&lt;/body&gt;</code>. Cela libère immédiatement la session lors de la déconnexion.
                  </p>
                </div>
              </div>
            </div>
